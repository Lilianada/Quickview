  ...
  return (
    <section>
      <div id="now" className="lg:hidden">
        ...
        <ul className="space-y-6 mb-10 list-disc pl-5">
          ...
          <li className="text-[12px] leading-6 lg:text-[14px]">
            <strong style={{ color: theme.primaryText }}>Sleeping More:</strong>{" "}
      ...
      <div id="desktop-now" className="hidden lg:flex flex-col">
        <h2
          className={`text-[20px] leading-[36px] font-semibold mb-12 text-left lg:text-[70px] lg:font-[900] lg:leading-[70px] lg:w-1/3 `}
          style={{ color: theme.primaryText }}
        >
